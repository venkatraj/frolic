...
Frolic is best suited for all types of site and uses Theme Customizer.
...
2. Upload the `frolic` folder to the `/wp-content/themes/` directory
...
9. Select Service section #1,#2,#3 and Service image section from the dropdown list.
